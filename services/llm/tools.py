...
DEBUG_LOG = True  # Flip False in production
...
def search_client(name: str) -> str:
    """Search client(s) by name or pan number and return list of matching records.
    ...
    # }
    # print(f"data we get from search client  : \n\n\n {payload}")
    return json.dumps(res, ensure_ascii=False)
# ----------------------------------------------------------------------
# ALL INVESTORS
# ----------------------------------------------------------------------
@tool
def all_investment(client_id: str) -> str:
    """List user's funds (FULL: keep raw + structured)"""
    # _dprint("all_investment:", client_id)
    res = api_all_investment(client_id)
...
# TOOL REGISTRY
# ----------------------------------------------------------------------
TOOLS = [rag_tool, search_client, all_investment, scheme_details, purchase]
